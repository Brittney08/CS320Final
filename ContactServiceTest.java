...
public class ContactServiceTest {
	...
	void newContactTest() {
		...
		assertAll("service", () -> assertNotNull(service.getContactList().get(0).getContactId()),
				...
				() -> assertEquals("1234559999", service.getContactList().get(0).getPhoneNumber()),
		...
		assertAll("service", () -> assertNotNull(service.getContactList().get(1).getContactId()),
				...
				() -> assertEquals("1234559999", service.getContactList().get(1).getPhoneNumber()),
		...
		assertAll("service", () -> assertNotNull(service.getContactList().get(2).getContactId()),
				...
				() -> assertEquals("1234559999", service.getContactList().get(2).getPhoneNumber()),
	...
	void updateAddressTest() throws Exception {
		...
		assertThrows(Exception.class, () -> service.Address(contactId, addressTest));
